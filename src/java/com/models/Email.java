...
public class Email {
    ...
    public static void sendEmail(Session session, String toEmail, String subject, String body) {
        try {
            ...
            msg.setFrom(new InternetAddress("travelapp9@gmail.com", "ABC travel"));

            msg.setReplyTo(InternetAddress.parse("noreply", false));
    ...
    public static void details(String receiver, String title, String content) {
        ...
        sendEmail(session, toEmail, title, content);
    }
}
